...
<body>
	...
	<p>This privacy policy discloses the privacy practices for vu. This
		privacy policy applies solely to information collected by this web
		site. It will notify you of the following: What personally
		identifiable information is collected from you through the web site,
		how it is used and with whom it may be shared. What choices are
		available to you regarding the use of your data. The security
		procedures in place to protect the misuse of your information. How you
		can correct any inaccuracies in the information.</p>
	...
	<p>We are the sole owners of the information collected on this
		...
		give us via email or other direct contact from you. We will not sell
		or rent this information to anyone. We will use your information to
	...
	<p>You may opt out of any future contacts from us at any
		time.Express any concern you have about our use of your data.</p>
	<h5>Security</h5>
	<p>We take precautions to protect your information. When you submit
		...
		that information is transmitted to us in a secure way. The
		computers/servers in which we store personally identifiable
		information are kept in a secure environment.</p>
	<h5>Updates</h5>
	<p>Our Privacy Policy may change from time to time and all updates
		will be posted on this page. If you feel that we are not abiding by
		this privacy policy, you should contact us immediately via telephone
		at XXX YYY-ZZZZ or via email.</p>
	<div class="container">
		<div class="row">
			<hr>
			<div class="col-lg-12">
