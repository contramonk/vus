        ...
        <section id="about" class="container content-section text-center">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>Deja Vu</h2>
                    <p>
                        A VU is a happy memory. One that you never want to forget.
                        It is a collection of photos, a description, a time, and a location -- organized
                        in an accessible manner.
                    </p>
                    <p>
                    	Bring back the vibrancy of the original experience by posting photos
                    	and documenting your travels and happy life events.
                    </p>
                    <p>
                    	Never forget the fun times you have!
