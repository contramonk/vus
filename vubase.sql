...
SET SQL_MODE = '';
GRANT USAGE ON *.* TO vuuser@localhost;
 DROP USER vuuser@localhost;
SET SQL_MODE='TRADITIONAL,ALLOW_INVALID_DATES';
CREATE USER 'vuuser'@'localhost' IDENTIFIED BY 'vuuser';

GRANT SELECT, INSERT, TRIGGER, UPDATE, DELETE ON TABLE * TO 'vuuser'@'localhost';
